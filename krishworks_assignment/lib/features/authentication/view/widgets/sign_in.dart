        ...
        builder: (context, showProgress, widget) {
          return Column(
            ...
            children: [
                    ...
                    child: Button(
                        ...
                        onPressed: () async {
                          if (await InputChecker.isValid(
                            inputs: [_emailController.text, _passwordController.text],
                          )) {
                            AuthController.instance.toggleProgress();

                            String message = await AuthController.instance.signIn(
              ...
              const Divider(thickness: AppDimensions.d1),
              TextButton(
                child: const Text('Forgot Password?'),
                onPressed: () {
                  if (!showProgress) {
                    AuthController.instance.setAuthMode(authMode: AuthMode.resetPassword);
                  }
                },
              ),
            ],
